...
def write_learners():
    ...
    learner_nouredine = Learner(first_name='Nouredine', last_name='Ouhaddou',
                                dob=date(1996, 10, 4), occupation='Engineer',
                                social_link='https://www.linkedin.com/ouhaddou/')
    learner_nouredine.save()
